...
class ViewController: UIViewController {
    ...
    func updateInterface(with currentWeather: CurrentWeather) {
        DispatchQueue.main.async {
            ...
            self.feelsLikeTemperatureLabel.text = currentWeather.fellsLikeTemperatureString
...
extension ViewController: CLLocationManagerDelegate {
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        networkWeatherManager.fetchCurrentWeather(forRequestType: .coordinate(latitude: latitude, longitude: longtude))
    }
